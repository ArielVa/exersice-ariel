...
(function (CellStatus) {
    ...
    CellStatus[CellStatus["WRONG"] = 1] = "WRONG";
    CellStatus[CellStatus["EXISTS"] = 2] = "EXISTS";
    CellStatus[CellStatus["EXACT"] = 3] = "EXACT";
})(CellStatus = exports.CellStatus || (exports.CellStatus = {}));
var Cell = /** @class */ (function () {
    function Cell(content, cellStatus) {
        if (content === void 0) { content = ''; }
        if (cellStatus === void 0) { cellStatus = CellStatus.EMPTY; }
        this.content = content;
        this.cellStatus = cellStatus;
    }
    Object.defineProperty(Cell.prototype, "CellStatus", {
        get: function () {
    ...
    Object.defineProperty(Cell.prototype, "CellContent", {
        get: function () {
            return this.content;
        },
        enumerable: false,
...
var Game = /** @class */ (function () {
    function Game() {
        ...
        this.reset();
        for (var i = 0; i < 30; i++) {
            this.cells.push(new cell_1.Cell());
        }
    }
    Game.prototype.addGuess = function (word) {
        ...
        if (word === this.wordToGuess) {
            ...
            for (var i = 0; i < word.length; i++) {
                ...
                this.cells[(this.currentRow * this.WORD_LENGTH) + i] = new cell_1.Cell(word[i], cellStatusToAdd);
            }
        }
        this.currentRow++;
        return true;
    ...
    Game.prototype.hasPlayerWon = function () {
        ...
        for (var i = 0; i < this.WORD_LENGTH; i++) {
            if (this.cells[((this.currentRow - 1) * this.WORD_LENGTH) + i].CellStatus !== cell_1.CellStatus.EXACT) {
                return false;
            }
        }
        return true;
    };
    Object.defineProperty(Game.prototype, "NumOfFilledRows", {
        get: function () {
    ...
    Object.defineProperty(Game.prototype, "NumOfRows", {
        get: function () {
    ...
    Object.defineProperty(Game.prototype, "WordLength", {
        get: function () {
...
var View2 = /** @class */ (function () {
    function View2(cbf) {
        ...
        for (var i = 1; i < 7; i++) {
            for (var j = 1; j < 6; j++) {
                this.inputGuessCells.push(document.getElementById("input_" + i + "_" + j));
            }
        }
